		...
		<div class="col-md-12">
			<div class="panel panel-<?php echo $color?>">
				...
				<div class="panel-body">
					<form id="form" role="form" method="post" action="<?php echo "index.php?pid=".base64_encode("ui/validateAltAnalysis.php")."&idGene=".$idGene."&nameMicroorganism=".$nameMicroorganism."&nameType=".$nameType ?>" enctype="multipart/form-data">
